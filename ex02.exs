...
defmodule Ex02 do
    # Part#1 using agents to implement the counter.
    def new_counter value do
        {:ok, iAgent} = Agent.start(fn -> value end)
        iAgent
    end

    def next_value(iAgent) do
       Agent.get_and_update(iAgent, &{&1, (&1+1)})
    end

    # Part#2 using Global counter to implement the counter.
...
defmodule Test do
  ...
  """
  ## Part#3  to implement the counter.
